...
SECRET_KEY = 'django-insecure-*-u+czkxp=@23ign+w+ebzt%u)jxwk^7+=8vy5tkpw2d+3p4c_'
...
TEMPLATES = [
    {
        ...
        'DIRS': ['templates'], # This is the line that needs to be added
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
EMAIL_HOST = 'smtp.gmail.com'  # Or the SMTP server of your provider
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = 'ekansh78198@gmail.com'  # Your email address
